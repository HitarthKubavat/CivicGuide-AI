...
class ElectionLogic:
    def __init__(self):
        ...
        self.journey_data = {
            "en": {
                "first_time_steps": [
                    {"title": "Application Submission", "desc": "Submit Form 6 online or offline with age/address proof.", "details": "<p class='mb-2'><b>Form 6 (New Voter) - Required Documents:</b></p><ul class='list-disc pl-5 space-y-1 mb-2'><li><b>1 Age Proof:</b> Birth certificate or 10th Marksheet.</li><li><b>1 Address Proof:</b> Electricity bill or Gas connection.</li><li><b>1 Photograph:</b> Recent passport-size colored photo.</li></ul><p class='mb-2'><b>Status Tracking:</b> You can use the official <b>Voter Helpline App</b> to track your application status easily by entering your reference ID.</p><p class='mb-2'>Choose the correct form for your need:</p><ul class='list-disc pl-5 space-y-1'><li><b>Form 6:</b> For new voters.</li><li><b>Form 8:</b> For corrections.</li><li><b>Form 6A:</b> For NRIs.</li></ul><p class='mt-2 text-xs text-slate-500'>Note: Accepted file formats are JPG/PDF (Max 2MB).</p>"},
            ...
            "hi": {
                "first_time_steps": [
                    {"title": "आवेदन जमा करना", "desc": "आयु/पता प्रमाण के साथ फॉर्म 6 ऑनलाइन या ऑफलाइन जमा करें।", "details": "<p class='mb-2'><b>फॉर्म 6 (नया मतदाता) - आवश्यक दस्तावेज:</b></p><ul class='list-disc pl-5 space-y-1 mb-2'><li><b>1 आयु प्रमाण:</b> जन्म प्रमाण पत्र या 10वीं की मार्कशीट।</li><li><b>1 पता प्रमाण:</b> बिजली का बिल या गैस कनेक्शन।</li><li><b>1 तस्वीर:</b> हालिया पासपोर्ट आकार की रंगीन तस्वीर।</li></ul><p class='mb-2'><b>स्थिति ट्रैकिंग (Status Tracking):</b> आप अपनी संदर्भ आईडी (Reference ID) दर्ज करके अपने आवेदन की स्थिति को आसानी से ट्रैक करने के लिए आधिकारिक <b>वोटर हेल्पलाइन ऐप (Voter Helpline App)</b> का उपयोग कर सकते हैं।</p><p class='mb-2'>अपनी आवश्यकता के अनुसार सही फॉर्म चुनें:</p><ul class='list-disc pl-5 space-y-1'><li><b>फॉर्म 6:</b> नए मतदाताओं के लिए।</li><li><b>फॉर्म 8:</b> सुधार के लिए।</li><li><b>फॉर्म 6A:</b> अनिवासी भारतीयों (NRI) के लिए।</li></ul><p class='mt-2 text-xs text-slate-500'>नोट: स्वीकृत फ़ाइल स्वरूप JPG/PDF (अधिकतम 2MB) हैं।</p>"},
            ...
            "gu": {
                "first_time_steps": [
                    {"title": "અરજી સબમિશન", "desc": "વય/સરનામાના પુરાવા સાથે ફોર્મ 6 ઓનલાઇન અથવા ઑફલાઇન સબમિટ કરો.", "details": "<p class='mb-2'><b>ફોર્મ 6 (નવો મતદાર) - જરૂરી દસ્તાવેજો:</b></p><ul class='list-disc pl-5 space-y-1 mb-2'><li><b>1 ઉંમરનો પુરાવો:</b> જન્મ પ્રમાણપત્ર અથવા 10માની માર્કશીટ.</li><li><b>1 સરનામાનો પુરાવો:</b> વીજળી બિલ અથવા ગેસ કનેક્શન.</li><li><b>1 ફોટોગ્રાફ:</b> તાજેતરનો પાસપોર્ટ સાઇઝનો રંગીન ફોટો.</li></ul><p class='mb-2'><b>સ્ટેટસ ટ્રેકિંગ (Status Tracking):</b> તમે તમારું રેફરન્સ આઈડી (Reference ID) દાખલ કરીને તમારી અરજીનું સ્ટેટસ સરળતાથી ટ્રેક કરવા માટે અધિકૃત <b>વોટર હેલ્પલાઇન એપ (Voter Helpline App)</b> નો ઉપયોગ કરી શકો છો.</p><p class='mb-2'>તમારી જરૂરિયાત મુજબ યોગ્ય ફોર્મ પસંદ કરો:</p><ul class='list-disc pl-5 space-y-1'><li><b>ફોર્મ 6:</b> નવા મતદારો માટે.</li><li><b>ફોર્મ 8:</b> સુધારા માટે.</li><li><b>ફોર્મ 6A:</b> બિન-નિવાસી ભારતીયો (NRI) માટે.</li></ul><p class='mt-2 text-xs text-slate-500'>નોંધ: સ્વીકૃત ફાઇલ ફોર્મેટ્સ JPG/PDF (મહત્તમ 2MB) છે.</p>"},
